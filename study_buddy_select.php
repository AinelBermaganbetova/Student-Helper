<html>
 ...
 <body>
  ...
  <div class="container">
   ...
   <br />
   <br />
   <h2 align="center">Study buddy</h2><br />
    ...
    border-radius: 40px; ">
     ...
     border-radius: 40px; ">
      ...
      border-radius: 40px; ">
       ...
       border-radius: 40px; ">Study buddy name</th>
       <th style="border: 2px solid rgb(46,0,78);
       border-radius: 40px; ">Email</th>
       <th style="border: 2px solid rgb(46,0,78);
       border-radius: 40px; ">Hobby</th>
  ...
  $.ajax({
   ...
   success:function(data)
   {
    ...
    if(data.length > 0)
    {
     ...
     {
      html += '<tr>';
      html += '<td>'+data[count].theUsername+'</td>';
      html += '<td>'+data[count].email+'</td>';
      html += '<td>'+data[count].a_hobby+'</td>';

     }
    }
    else
    {
     html = '<tr><td colspan="5">no data here</td></tr>';
    }
    $('tbody').html(html);
   }
  })
